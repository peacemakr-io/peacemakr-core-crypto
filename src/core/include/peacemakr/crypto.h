...
/**
 * Create a new peacemakr_key_t from a master key generated by the peacemakr key generator
 * or through an external API. Uses HMAC SHA256 with \p key_id on \p master_key to create
 * a new key that can be used in further cryptographic endeavors.
 */
