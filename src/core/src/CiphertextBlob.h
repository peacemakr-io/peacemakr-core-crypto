...
const buffer_t *CiphertextBlob_encrypted_key(const ciphertext_blob_t *ciphertext);
...
const symmetric_cipher CiphertextBlob_symm_cipher(const ciphertext_blob_t *ciphertext);
...
const encryption_mode CiphertextBlob_encryption_mode(const ciphertext_blob_t *ciphertext);
